...
import {Text, Button, Icon,Select, IndexPath, SelectItem, Layout} from '@ui-kitten/components';
...
const Detalle = ({route: {params}, ...props}) => {
  ...
  const {obtenerCategoriasDelProducto,compradores} = useContext(StoreContext);
